...
def main():
    ...
    ap.add_argument("--out-dir", type=str, default="newAnalysis",
                    help="Directory to save outputs (relative to project root).")
    ap.add_argument("--out-csv", type=str, default="noise_sweep_scores_gpu.csv",
                    help="Output CSV filename (saved inside --out-dir).")
    ...
    out_csv = (out_dir / args.out_csv).resolve()
