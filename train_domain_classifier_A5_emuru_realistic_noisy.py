#!/usr/bin/env python
"""
Train IAM vs Emuru domain classifier on A5_emuru_realistic_noisy data.

- Uses domain_classification_sentences_A5_emuru_realistic_noisy.csv
- No geometric/photometric/normalization augmentation (A5 images are already 'baked').
"""
...
BEST_MODEL_PATH = CHECKPOINT_DIR / "domain_cnn_best_A5_emuru_realistic_noisy.pt"
...
def create_dataloaders(
    ...
    """
    Create train / val / test DataLoaders from the A5 CSV.
    No augmentations, no normalization — the A5 images are already 'baked'.
    """
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train IAM vs Emuru DomainCNN with A5_emuru_realistic_noisy images"
    )
    ...
    parser.add_argument(
        ...
        help="Path to A5 domain classification CSV (relative to project root)",
    )
